...
const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "🆓 يمكنك تجربة تحويل حتى 50 فاتورة خلال شهر مجاناً. بعد ذلك يمكنك اختيار الباقة الأنسب لك."
    },
    {
    ...
    },
    {
      ...
      answer: "🔒 نعم، لا يتم حذف البيانات بل تخزينها في السحابة بأعلى معايير الأمان والتشفير."
    },
    {
